...
<div class='container'>
    <table class='table table-bordered table-striped'>
        ...
        <c:forEach items="${listLib}" var="x" varStatus="loop">
            <tr>
                <td>${x.idLibrarian}</td>
                <td>${x.nameLibrarian}</td>
                <td>${x.emailLibrarian}</td>
                <td>${x.passwordLibrarian}</td>
                <td>${x.phoneLibrarian}</td>
                <td><a href='account?action=editlib&id=${x.idLibrarian}'>Edit</a></td>
                <td><a href='account?action=deletelib&id=${x.idLibrarian}'>Delete</a></td></tr>
        </c:forEach>
    </table>
</div>
</body>
